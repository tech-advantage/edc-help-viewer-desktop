...
const EDC_VIEWER_FOLDER_VERSION = "edc-help-viewer.3.3.1";
		...
		new FileManagerPlugin({
			events: {
				onEnd: {
					...
					copy: [
						{
							source: ROOT_FOLDER + "/conf/config.json",
							destination: ROOT_FOLDER + "/static/help/assets/config.json",
						},
						{
							source: ROOT_FOLDER + "/conf/index.html",
							destination: ROOT_FOLDER + "/static/help/",
						},
					],
					delete: [
